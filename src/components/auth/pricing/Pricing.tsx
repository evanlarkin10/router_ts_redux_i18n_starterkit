    ...
    return (
      <Container maxWidth="md" component="main">
        ...
        <Avatar className={classes.avatar}>
          ...
          <Typography variant="h5" align="center" color="textSecondary" component="p" style={{paddingBottom:10}}>
          ...
          {tiers.map(tier => (
            ...
            <Grid item key={tier.title} xs={12} sm={tier.title === 'Enterprise' ? 12 : 6} md={4}>
              <Card>
                ...
                <CardActions>
                  <Button fullWidth variant='outlined' color="primary" onClick={()=>this.handleSelectTier(tier.title)}>
                    {tier.buttonText}
                  </Button>
                </CardActions>
              </Card>
